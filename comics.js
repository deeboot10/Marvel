...
function callApi(){
  ...
  if(isSearched) params.titleStartsWith = searchQuery; // diff
  else delete params.titleStartsWith;
  
  let url = apiinfo.firstPartComics + apiinfo.createParams(params);
